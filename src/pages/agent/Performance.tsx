    ...
    <div className="container mx-auto px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="p-6">
          ...
          <p className="text-xs text-muted-foreground mt-1">You're outperforming {performance.percentile}% of your team</p>
        </Card>
      </div>
      ...
      <Card className="p-6">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={performance.weeklyTrend}>
            ...
            <Line type="monotone" dataKey="sentiment" stroke="hsl(var(--primary))" strokeWidth={2} dot={{ fill: 'hsl(var(--primary))' }} />
          </LineChart>
        </ResponsiveContainer>
      </Card>
    </div>
