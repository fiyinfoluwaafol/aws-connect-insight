...
########################################
TEST_EMAIL = "test_user_8@example.com"
TEST_SUPERVISOR_EMAIL = "supervisor8@test.io"
TEST_PASSWORD = "password123"
TEST_TEAM_NAME = "Test Team Golf"
...
try:
    ...
    updated = calls.update_call(client, call1["id"], transcript)
